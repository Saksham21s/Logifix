    ...
    return (
        <>
            ...
            <nav className={`navbar navbar-expand-lg navbar-top ${scrolled ? "hidden" : ""}`}>
                ...
                <Link to="/contacts">
                    <div className="signup-btn">Sign Up <FaArrowRight className="icon" /></div>
                </Link>
            </nav>
                    ...
                    <ul className="navbar-nav ms-auto"> 
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu ${activeDropdown === "pages" ? "show" : ""}`}>
                                ...
                                <li className="dropdown-submenu">
                                    <Link className="dropdown-item" to="#" onClick={closeNavbar}>Projects</Link>
                                </li>
                                <li className="dropdown-submenu">
                                    <Link className="dropdown-item" to="#" onClick={closeNavbar}>Team</Link>
                                </li>
                                <li className="dropdown-submenu">
                                    <Link className="dropdown-item" to="#" onClick={closeNavbar}>Shop</Link>
                                </li>
                                <li><Link className="dropdown-item" to="/testinomial" onClick={closeNavbar}>Testinomial</Link></li>
                                <li><Link className="dropdown-item" to="/pricing" onClick={closeNavbar}>Pricing</Link></li>
                            </ul>
